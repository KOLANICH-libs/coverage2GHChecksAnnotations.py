...
* `coverageReportGHChecksAnnotations <coverage database file> <project name> <root dir of the project to generate relative paths>` not just generates the dict, but also sends the data to GitHub using [miniGHAPI](https://github.com/KOLANICH/miniGHAPI.py) lib.

for convenience we have [a GitHub Action doing this](https://github.com/KOLANICH-GHActions/coveragepyReport).
